...
<body>
    ...
    <main>
        ...
        <form action="../check.php" method="post"  >
            ...
            <div class="bar"></div>
            <input class="hide" name="order" type="text" value="<?php echo $ton_katu->getName(); ?>" style="visibility: hidden;">

            <h4><?php echo $ton_katu->getName() ;?></h4>

            <div class="menus">
                <a href="" class="menu">
                    <img src="../img/<?php echo $ton_katu->getImage(); ?>" alt="">
                </a>
