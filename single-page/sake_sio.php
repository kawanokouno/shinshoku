...
<body>
    ...
    <main>
        ...
        <form action="../check.php" method="post"  >
            ...
            <div class="bar"></div>
            <input class="hide" name="order" type="text" value="<?php echo $sake_sio->getName(); ?>" style="visibility: hidden;">

            <h4><?php echo $sake_sio->getName() ;?></h4>

            <div class="menus">
                <a href="" class="menu">
                    <img src="../img/<?php echo $sake_sio->getImage(); ?>" alt="">
                </a>
